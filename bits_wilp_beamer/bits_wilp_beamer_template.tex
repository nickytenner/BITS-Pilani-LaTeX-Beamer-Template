...
\subtitle{Course Number: CHE F212\\Title: Fluid Mechanics\\Lecture No. 1} %This will appear in the second title only if the beamer is set to lecture mode.
\author{Eldhose Iype} % Your name
\institute[BITS Pilani, Dubai Campus]{} % Your institution as it will appear on the bottom of every slide, may be 
...
\titlepage
\end{frame}
% For lectures, uncomment these lines to get the second title page. also make changes in beamerthemebits.sty
\begin{frame}
\titlepage
\end{frame} 
